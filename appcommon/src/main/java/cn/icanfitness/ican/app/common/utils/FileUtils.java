...
public class FileUtils {
    ...
    public static File getSDRootFile() {
        ...
        return AppCommon.getInstance().getApplicationContext().getExternalFilesDir(null);
    }
    ...
    public static boolean copyFile(String oldPath, String newPath) {
        ...
        try {
            ...
            if (!newFileDir.exists()) {
                boolean succ = newFileDir.mkdirs();
            ...
            CommonUtil.err(" er "+e.getMessage());
    ...
    public static boolean copyRawFile(Context context, int rawId, String newPath) {
        InputStream inStream = null;
        FileOutputStream fs = null;
        boolean result = false;
        try {
            int bytesum = 0;
            int byteread = 0;
            inStream = context.getResources().openRawResource(rawId);

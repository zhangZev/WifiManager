package com.wanzhong.core.view.bottombar;
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                //bottomBarItem.setOnTouchListener(new MyOnTouchListener(i));
                bottomBarItem.setOnClickListener(new MyOnClickListener(mItemViews.size() - 1));
//                bottomBarItem.setOnTouchListener(new OnTouchListener() {
//                    @Override
//                    public boolean onTouch(View v, MotionEvent event) {
//                        Log.e("cx","============ontouch======="+event.getAction()+" ==  "+event.getX()+"  === "+event.getY()+" ==== "+event.getDownTime());
//                        return false;
//                    }
//                });
                /*bottomBarItem.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Log.e("cx","============setOnClickListener======="+v);
    ...
    /*private class MyOnTouchListener implements  OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if(action == MotionEvent.ACTION_UP){
                if(event.getX() > 0 && event.getY() > 0 && (event.getEventTime() - event.getDownTime()) < 500){
                    if (mViewPager != null) {
                        //有设置viewPager

...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        iconWidth = ta.getDimensionPixelSize(R.styleable.BottomBarItem_biconWidth, 0);
        iconHeight = ta.getDimensionPixelSize(R.styleable.BottomBarItem_biconHeight, 0);
    ...
    private void init() {
        ...
        mTvNotify.setImageDrawable(notifyPointBg);//设置提示点的背景颜色
    ...
    private void setTvVisible(View tv) {
        //都设置为不可见

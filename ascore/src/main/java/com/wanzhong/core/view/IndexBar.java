...
public class IndexBar extends View {
    ...
    private static final int LETTER_COLOR = 0xFF019EE8;
    /**
     * 索引字母数组
     */
    ...
    private void init() {
        ...
        mPaint.setTextSize(UIUtils.dip2Px(getContext(), 12));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mMarginTop = (mHeight - mCellHeight * indexs.length) / 2;
        android.util.Log.e("cx",getHeight()+" ===== "+getMeasuredHeight()+" ===  "+mCellHeight+" ==== "+mMarginTop);

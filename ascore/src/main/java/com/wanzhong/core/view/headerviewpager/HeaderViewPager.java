package com.wanzhong.core.view.headerviewpager;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                 ...
                 */
                CommonUtil.err("verticalScrollFlag "+verticalScrollFlag+" --- "+(!isStickied())+" === "+mScrollable.isTop()+" ====  "+isClickHead);
            ...
            case MotionEvent.ACTION_UP:
                CommonUtil.err("verticalScrollFlag "+verticalScrollFlag);
                if (verticalScrollFlag) {
                    ...
                    CommonUtil.err(mDirection+ "  verticalScrollFlag "+verticalScrollFlag +" === getScrollY() "+getScrollY()+" ====  "+yVelocity);
